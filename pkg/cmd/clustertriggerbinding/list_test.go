	...
	ctbs := []*v1alpha1.ClusterTriggerBinding{
		{
			ObjectMeta: v1.ObjectMeta{
				Name:              "ctb1",
				CreationTimestamp: v1.Time{Time: now.Add(-2 * time.Minute)},
			},
		},
		{
			ObjectMeta: v1.ObjectMeta{
				Name:              "ctb2",
				CreationTimestamp: v1.Time{Time: now.Add(-30 * time.Second)},
			},
		},
		{
			ObjectMeta: v1.ObjectMeta{
				Name:              "ctb3",
				CreationTimestamp: v1.Time{Time: now.Add(-200 * time.Hour)},
			},
		},
		{
			ObjectMeta: v1.ObjectMeta{
